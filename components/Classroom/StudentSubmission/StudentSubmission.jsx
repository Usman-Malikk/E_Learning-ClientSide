...
const StudentSubmission = () => {
  ...
  console.log(
    "🚀 ~ file: StudentSubmission.jsx:20 ~ StudentSubmission ~ inputFile:",
    inputFile
  );
  ...
  const getSubmission = () => {
    ...
    axios
      .post(
        "http://localhost:5000/classes/getSubmission",
        {
  ...
  const getAssignment = () => {
    ...
    axios
      .post(
        "http://localhost:5000/classes/getAssignment",
        {
          assignmentId: assignmentId,
        },
        {
  ...
  const getClassDetails = () => {
    ...
    axios
      .post(
        "http://localhost:5000/classes/getClassroom",
        {
          classCode: classCode,
        },
        {
  ...
  const submitFile = async () => {
    ...
    const Filename = axios
      ...
      .then((res) => {
        ...
        axios
          .post(
            "http://localhost:5000/classes/submitAssignment",
            {
              studentName: userData.userName,
              studentEmail: userData.userEmail,
              assignmentId: assignmentId,
  ...
  const unSubmitFile = () => {
    ...
    axios
      .delete(
        "http://localhost:5000/classes/deleteSubmission",
        {
          data: {
            assignmentId: assignmentId,
            userEmail: userData.userEmail,
          ...
          <div className="col-md-5 col-lg-4 Upload_Options">
            {uploadState == 2 ? (
              <div className="col d-flex mt-4 pt-3 justify-content-between border-bot fs-5">
                ...
                <div className="mt-1 fs-6 fw-bold text-success">Submitted</div>
              </div>
            ) : (
