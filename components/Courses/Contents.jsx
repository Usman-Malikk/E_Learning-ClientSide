...
const Contents = ({
  ...
  console.log("🚀 ~ file: Contents.jsx:15 ~ Contents ~ contents:", contents);
  ...
  const getContents = () => {
    ...
    axios
      .post(
        "http://localhost:5000/courses/getContents",
        {
          classCode: classCode,
        },
                ...
                >
                  ...
                  <div className="Assignment_Box d-flex flex-column justify-content-center p-1">
                    <div className="Assignment_Img">
                      <img
                        src="https://firebasestorage.googleapis.com/v0/b/edeasy-90583.appspot.com/o/assignments%2FWhatsApp%20Image%202021-10-17%20at%204.55.04%20AM.jpeg?alt=media&token=db78b70d-2b09-4cbb-b5ac-d47e2392bd31"
                        alt=""
                      />
                      <div className="Assignment_Name">{content.name}</div>
                    </div>
                    <div className="Assignment_Desc">{content.desc}</div>
                  </div>
                </a>
              </div>
            );
