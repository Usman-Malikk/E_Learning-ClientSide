        ...
        <div className="side-drawer h-100">
          ...
          <ul className="d-flex flex-column mt-3 side-drawer-links">
            ...
            </li>
            {
              (token) ? (
                <li>
                  <Link to="/courses" activeClassName="selected" exact>Courses</Link>
                </li>
              ) : ""
            }
            {
              (token) ? (
                <li>
                  <Link to="/resources" activeClassName="selected" exact>Resources</Link>
                </li>
              ) : ""
            }
            {
              (token) ? (
                <li>
                  <Link to="/forum" activeClassName="selected" exact>Discussion</Link>
                </li>
              ) : ""
            }
            {
              (token) ? (
                <li>
                  <Link to="/classes" activeClassName="selected" exact>Live Classrooms</Link>
                </li>
              ) : ""
            }
            <ConditionalBtn/>
